  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border p-6">
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        <h4 className="font-medium text-blue-900 mb-2">Quick Add via Command Line</h4>
        <p className="text-sm text-blue-800 mb-2">
          You can also add admins using the command line:
        </p>
        <code className="text-xs bg-blue-100 text-blue-900 px-2 py-1 rounded block">
          cd server && node seed-admin.js --name "Admin Name" --email "admin@example.com" --password "password123"
        </code>
      </div>
    </div>
  );
